            ...
            <ul class="flex items-center gap-1">
                ...
                @foreach ($menus as $menu)
                    <li class="group relative">
                        <button
                            type="button"
                            class="flex h-9 items-center gap-1.5 rounded-lg px-3 text-sm font-medium text-gray-700 transition hover:bg-emerald-50 hover:text-emerald-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 dark:text-gray-200 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-300"
                        >
